...
contract HeadShot is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        address hsFactoryAddress = 0xB96ef3e8e341f829abFa200a39D543e61F7677b8; // in Ropsten
        headShotFactory = IHeadShotFactory(hsFactoryAddress);
        headShotFactory.transferOwnership(address(this));
    }
    ...
    function setTokenAsFactoryOwnership() public virtual onlyOwner {
        headShotFactory.transferOwnership(address(this));
    }
    ...
    function setFactoryOwnership(address payable newWallet_) public virtual onlyOwner {
        ...
        headShotFactory.transferOwnership(newWallet_);
    }

    function setFactoryAddress(address payable newWallet_) public virtual onlyOwner {
        require(newWallet_ != address(0), "ERR: Transfer to the zero address");
        hsFactoryAddress = newWallet_;
        headShotFactory = IHeadShotFactory(hsFactoryAddress);
    }
